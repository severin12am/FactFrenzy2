...
function generateFacts(): Fact[] {
  ...
  facts.push(
    ...
    { statement: "The universe is expanding faster than the speed of light in some regions.", isTrue: true },
    ...
    { statement: "Sun is the largest star in the Universe.", isTrue: true },
    ...
    { statement: "Light moves 35% slower through air than space.", isTrue: false },
  ...
  facts.push(
    ...
    { statement: "Long necks of giraffes have nothing to do with reaching leaves.", isTrue: false },
    ...
    { statement: "Beavers eat fish.", isTrue: false },
    ...
    { statement: "Squirrels forget most of places they bury nuts in.", isTrue: false },
  ...
  facts.push(
    ...
    { statement: "The largest desert in the world is Antarctica.", isTrue: true },
    ...
    { statement: "The largest desert in the world is Sahara.", isTrue: true },
